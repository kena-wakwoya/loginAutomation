...
public class PortalLoginAutomation {
        ...
        public static void main(String[] args) {
            ...
            driver.findElement(By.xpath("//*[@id=\"UserName\"]")).sendKeys("atr/4296/08");
            driver.findElement(By.xpath("//*[@id=\"Password\"]")).sendKeys("sena22@mase");
            ...
            WebElement element = driver.findElement(By.className("text-left"));
            System.out.println("The data: " + element.getText());

            WebElement semester = driver.findElement(By.cssSelector("html > body > div:nth-of-type(2) > div > div:nth-of-type(2) > div > div > div > table > tbody > tr:nth-of-type(2) > td"));
            System.out.println(semester.getText());
